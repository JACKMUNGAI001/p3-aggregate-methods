...
class Student:
    ...
    def get_enrollments(self):
        ...
        def aggregate_average_grade(self):
            """Return the average grade for the student across all courses."""
            # Assume grades are stored in a protected attribute called _grades
            if not hasattr(self, '_grades') or not self._grades:
                return None  # or 0, or raise Exception if preferred
...
class Enrollment:
    ...
    def get_enrollment_date(self):
        ...
        def aggregate_enrollments_per_day(cls):
            """Return a dictionary with the count of enrollments per day."""
            enrollment_count = {}
